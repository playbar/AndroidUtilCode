 ...
 * @hide
 */
public class ScriptField_two_element_struct_i8_v128 extends Script.FieldBase {
    ...
    public static Element createElement(RenderScript rs) {
        ...
        eb.add(Element.I8(rs), "a");
        eb.add(Element.U32(rs), "#rs_padding_1");
        eb.add(Element.U32(rs), "#rs_padding_2");
        eb.add(Element.U32(rs), "#rs_padding_3");
        eb.add(Element.U16(rs), "#rs_padding_4");
        eb.add(Element.U8(rs), "#rs_padding_5");
        eb.add(Element.F32_4(rs), "b");
        return eb.create();
    }

    private  ScriptField_two_element_struct_i8_v128(RenderScript rs) {
        mItemArray = null;
        mIOBuffer = null;
        mElement = createElement(rs);
    }

    public  ScriptField_two_element_struct_i8_v128(RenderScript rs, int count) {
        mItemArray = null;
        mIOBuffer = null;
        mElement = createElement(rs);
        init(rs, count);
    ...
    public  ScriptField_two_element_struct_i8_v128(RenderScript rs, int count, int usages) {
        mItemArray = null;
        mIOBuffer = null;
        mElement = createElement(rs);
    ...
    public static ScriptField_two_element_struct_i8_v128 create1D(RenderScript rs, int dimX, int usages) {
        ScriptField_two_element_struct_i8_v128 obj = new ScriptField_two_element_struct_i8_v128(rs);
        obj.mAllocation = Allocation.createSized(rs, obj.mElement, dimX, usages);
        return obj;
    }

    public static ScriptField_two_element_struct_i8_v128 create1D(RenderScript rs, int dimX) {
        return create1D(rs, dimX, Allocation.USAGE_SCRIPT);
    }

    public static ScriptField_two_element_struct_i8_v128 create2D(RenderScript rs, int dimX, int dimY) {
        return create2D(rs, dimX, dimY, Allocation.USAGE_SCRIPT);
    }

    public static ScriptField_two_element_struct_i8_v128 create2D(RenderScript rs, int dimX, int dimY, int usages) {
        ScriptField_two_element_struct_i8_v128 obj = new ScriptField_two_element_struct_i8_v128(rs);
    ...
    public static ScriptField_two_element_struct_i8_v128 createCustom(RenderScript rs, Type.Builder tb, int usages) {
        ScriptField_two_element_struct_i8_v128 obj = new ScriptField_two_element_struct_i8_v128(rs);
        Type t = tb.create();
    ...
    public synchronized void set_a(int index, byte v, boolean copyNow) {
        if (mIOBuffer == null) mIOBuffer = new FieldPacker(mElement.getBytesSize() * getType().getX()/* count */);
        if (mItemArray == null) mItemArray = new Item[getType().getX() /* count */];
    ...
    public synchronized void set_b(int index, Float4 v, boolean copyNow) {
        if (mIOBuffer == null) mIOBuffer = new FieldPacker(mElement.getBytesSize() * getType().getX()/* count */);
        if (mItemArray == null) mItemArray = new Item[getType().getX() /* count */];
        if (mItemArray[index] == null) mItemArray[index] = new Item();
    ...
    public synchronized byte get_a(int index) {
        if (mItemArray == null) return 0;
        return mItemArray[index].a;
    }

    public synchronized Float4 get_b(int index) {
        if (mItemArray == null) return null;
