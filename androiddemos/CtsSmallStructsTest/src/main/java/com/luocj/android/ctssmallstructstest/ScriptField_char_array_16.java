 ...
 * @hide
 */
public class ScriptField_char_array_16 extends Script.FieldBase {
    ...
    public static Element createElement(RenderScript rs) {
        ...
        eb.add(Element.I8(rs), "bytes", 16);
        return eb.create();
    }

    private  ScriptField_char_array_16(RenderScript rs) {
        mItemArray = null;
        mIOBuffer = null;
        mElement = createElement(rs);
    }

    public  ScriptField_char_array_16(RenderScript rs, int count) {
        mItemArray = null;
        mIOBuffer = null;
        mElement = createElement(rs);
        init(rs, count);
    ...
    public  ScriptField_char_array_16(RenderScript rs, int count, int usages) {
        mItemArray = null;
        mIOBuffer = null;
        mElement = createElement(rs);
    ...
    public static ScriptField_char_array_16 create1D(RenderScript rs, int dimX, int usages) {
        ScriptField_char_array_16 obj = new ScriptField_char_array_16(rs);
        obj.mAllocation = Allocation.createSized(rs, obj.mElement, dimX, usages);
        return obj;
    }

    public static ScriptField_char_array_16 create1D(RenderScript rs, int dimX) {
        return create1D(rs, dimX, Allocation.USAGE_SCRIPT);
    }

    public static ScriptField_char_array_16 create2D(RenderScript rs, int dimX, int dimY) {
        return create2D(rs, dimX, dimY, Allocation.USAGE_SCRIPT);
    }

    public static ScriptField_char_array_16 create2D(RenderScript rs, int dimX, int dimY, int usages) {
        ScriptField_char_array_16 obj = new ScriptField_char_array_16(rs);
    ...
    public static ScriptField_char_array_16 createCustom(RenderScript rs, Type.Builder tb, int usages) {
        ScriptField_char_array_16 obj = new ScriptField_char_array_16(rs);
        Type t = tb.create();
