 ...
 * @hide
 */
public class ScriptField_two_element_struct_f32_f64 extends Script.FieldBase {
    ...
    private  ScriptField_two_element_struct_f32_f64(RenderScript rs) {
        mItemArray = null;
        mIOBuffer = null;
        mElement = createElement(rs);
    }

    public  ScriptField_two_element_struct_f32_f64(RenderScript rs, int count) {
        mItemArray = null;
        mIOBuffer = null;
        mElement = createElement(rs);
        init(rs, count);
    ...
    public  ScriptField_two_element_struct_f32_f64(RenderScript rs, int count, int usages) {
        mItemArray = null;
        mIOBuffer = null;
        mElement = createElement(rs);
    ...
    public static ScriptField_two_element_struct_f32_f64 create1D(RenderScript rs, int dimX, int usages) {
        ScriptField_two_element_struct_f32_f64 obj = new ScriptField_two_element_struct_f32_f64(rs);
        obj.mAllocation = Allocation.createSized(rs, obj.mElement, dimX, usages);
        return obj;
    }

    public static ScriptField_two_element_struct_f32_f64 create1D(RenderScript rs, int dimX) {
        return create1D(rs, dimX, Allocation.USAGE_SCRIPT);
    }

    public static ScriptField_two_element_struct_f32_f64 create2D(RenderScript rs, int dimX, int dimY) {
        return create2D(rs, dimX, dimY, Allocation.USAGE_SCRIPT);
    }

    public static ScriptField_two_element_struct_f32_f64 create2D(RenderScript rs, int dimX, int dimY, int usages) {
        ScriptField_two_element_struct_f32_f64 obj = new ScriptField_two_element_struct_f32_f64(rs);
    ...
    public static ScriptField_two_element_struct_f32_f64 createCustom(RenderScript rs, Type.Builder tb, int usages) {
        ScriptField_two_element_struct_f32_f64 obj = new ScriptField_two_element_struct_f32_f64(rs);
        Type t = tb.create();
