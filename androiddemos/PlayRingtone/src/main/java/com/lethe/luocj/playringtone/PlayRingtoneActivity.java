package com.lethe.luocj.playringtone;
...
public class PlayRingtoneActivity extends Activity {
    ...
    private static String TAG = PlayRingtoneActivity.class.getSimpleName();
    ...
    private String getUrl() {
        ...
        Uri url = RingtoneManager.getActualDefaultRingtoneUri(this, RingtoneManager.TYPE_NOTIFICATION);
        Log.d(TAG, "getActualDefaultRingtoneUri " + url.toString());
        return url.toString();
    }
